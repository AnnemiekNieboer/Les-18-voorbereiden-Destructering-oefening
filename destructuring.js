...
console.log(`The price is ${price} and the refresh rate is ${refreshRate}`);
...
console.log(`The type is ${type} and the brand is ${brand}`);
...
console.log(`Wifi: ${wifi} and bluetooth: ${bluetooth}`);
...
const [internetConncection, otherConnections] = connectivity;
console.log(`You can connect with the internet by ${internetConncection} and you also have ${otherConnections}`);
...
console.log(`${firstNumber} and ${thirdNumber}`);
...
const [introductionSentenceName, introductionSentenceAge] = getDetails("annemiek", 34);
console.log(`${introductionSentenceName} ${introductionSentenceAge}`);